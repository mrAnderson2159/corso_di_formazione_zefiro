...
namespace OrdiniAdoNet.DAO
{
    internal class Dao
    {
        ...
        private const string _connectionString = @"Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=Ordini;Integrated Security=True";
        ...
        public object? Scalar(string query, params SqlParameter[] parameters)
        {
            GetCommand(out SqlCommand command, query, convertNulls: false, parameters);
